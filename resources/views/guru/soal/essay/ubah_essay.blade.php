...
<ol class="breadcrumb">
  ...
  <li><a href="{{ url('soalsiswa/detail/'.$essay->id) }}">Detail Soal</a></li>
...
<div class="col-md-12">
  ...
  <div class="box box-info">
    ...
    <form class="form-horizontal" action="{{ url('/soalsiswa/essay/'.$essay->id) }}" method="POST">
      {{ csrf_field() }}
      <input type="hidden" name="_method" value="PUT">
      <input type="hidden" name="ulangans_id" value="{{ $essay->ulangans_id }}">
      <div class="box-body">
        <div class="box-body">
