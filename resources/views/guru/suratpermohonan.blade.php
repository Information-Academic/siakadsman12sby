...
@section('heading', 'Surat Permohonan Guru')
@section('page')
  <li class="breadcrumb-item active">Surat Permohonan Guru</li>
@endsection
@section('content')
<div class="col-md-12">
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Surat Permohonan Guru</h3>
      </div>
      <form action="{{route('guru.suratPermohonanStore')}}" method="post">
        @csrf
        <div class="card-body">
