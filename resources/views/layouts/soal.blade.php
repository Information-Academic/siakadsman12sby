...
<head>
  ...
  <link rel="icon" href="{{ asset('img/sman12sby.png') }}" type="image/png"/>
  <style type="text/css">
    .dataTable td{
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar" style="background-color: lightcoral;">
      <!-- Sidebar user panel -->
      ...
      <ul class="sidebar-menu">
        <li class="header" style="background-color: lightcoral;">MAIN NAVIGATION</li>
